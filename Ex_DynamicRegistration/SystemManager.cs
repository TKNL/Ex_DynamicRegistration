...
using Crestron.SimplSharpPro.UI;                 // For all interfaces
...
namespace Ex_DynamicRegistration
{
    ...
    public class SystemManager
    {
        ...
        /// </summary>
        private const string LogHeader = "[Manager] ";
                ...
                foreach (var touchpanel in config.Touchpanels)
                {
                    ...
                    if (this.touchpanels[touchpanel.Label].Register())
                    {
                        try
                        {
                            ...
                            // 2 different ways to work with Smart Objects
                            ...
                            {
                                // Two different ways to work with strings
                                // String interpolation allows for more readable syntax
                            ...
                            // set the destination labels and dynamic icons
                            foreach (var destination in config.Destinations)
                            {
                                // Again, another way of working with Smart Object properties
        ...
        private void SO_Value_SigChange(GenericBase currentDevice, SmartObjectEventArgs args)
        {
            try
            {
                ...
                string message = "QUEUE MESSAGE - " + args.Sig.Name;
